export default function Item({ name, quantity, category, onSelect }) {
  return (
    <li
      onClick={onSelect}
      className="flex justify-between items-center bg-slate-800 p-4 rounded-lg mb-3 border border-slate-700 hover:bg-slate-700 transition-colors cursor-pointer"
    >
      <div>
